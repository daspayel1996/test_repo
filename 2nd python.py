...
label =Label(window, textvariable=equation_label,font=('consolas',15),bg="white",bd=6, width=24, height=2)
label.pack()
...
calculate = Button(frame, text='=', height=4, width=9, font=35, command=calculate)
calculate.grid(row=3, column=2)

decimal = Button(frame, text='.', height=4, width=9, font=35, command=lambda: button_press('.'))
decimal.grid(row=3, column=1)

clear = Button(window, text='CC', height=4, width=10, font=35, command=clear)
clear.pack()
